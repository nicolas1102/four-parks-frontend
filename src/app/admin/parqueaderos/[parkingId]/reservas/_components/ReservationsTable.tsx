...
import ReservationsTableColumns from '../_lib/ReservationsTableColumns'

export function ReservationsTable({ data }: { data: ReservationInterface[] }) {
  const { table, columns } = ReservationsTableColumns({ data })
  return (
